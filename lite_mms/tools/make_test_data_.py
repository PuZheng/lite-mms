...
class InitializeTestDB(Command):
    ...
    def run(self):
        ...
        vehicle3 = do_commit(Vehicle(plate=u"浙A 00003"))
        vehicle4 = do_commit(Vehicle(plate=u"浙A 00004"))
        vehicle5 = do_commit(Vehicle(plate=u"浙A 00005"))
...
#            administrator = do_commit(administrator)
            ...
            unload_session1 = do_commit(UnloadSession(plate=vehicle1.plate, gross_weight=10000, with_person=True,
                                                      finish_time=datetime.now()))
            unload_session2 = do_commit(UnloadSession(plate=vehicle2.plate, gross_weight=10000, with_person=False, finish_time=datetime.now()))
            unload_session3 = do_commit(UnloadSession(plate=vehicle3.plate, gross_weight=10000, with_person=False, finish_time=datetime.now()))
            unload_session4 = do_commit(UnloadSession(plate=vehicle4.plate, gross_weight=10000, with_person=False, finish_time=datetime.now()))
            unload_task1 = do_commit(
                UnloadTask(unload_session1, hr1, customer1, l, product1, "",
                           weight=300))
            unload_task2 = do_commit(
                UnloadTask(unload_session1, hr1, customer1, l, product2, "",
                           weight=600))
            unload_task3 = do_commit(
                UnloadTask(unload_session1, hr1, customer1, l, product3, "",
                           weight=1000))
            unload_task4 = do_commit(
                UnloadTask(unload_session2, hr2, customer2, l, product1, "",
                           weight=4000))
            unload_task5 = do_commit(
                UnloadTask(unload_session2, hr2, customer2, l, product2, "",
                           weight=500))
            unload_task6 = do_commit(
                UnloadTask(unload_session2, hr2, customer2, l, product3, "",
                           weight=500))
            unload_task7 = do_commit(
                UnloadTask(unload_session3, hr1, customer3, l, product1, "",
                           weight=800))
            unload_task8 = do_commit(
                UnloadTask(unload_session3, hr1, customer3, l, product2, "",
                           weight=800))
            unload_task9 = do_commit(
                UnloadTask(unload_session3, hr1, customer3, l, product3, "",
                           weight=800))
            unload_task10 = do_commit(UnloadTask(unload_session4,hr1,customer3,l,product3,"",weight=800))
            ...
            delivery_session = do_commit(DeliverySession(vehicle1.plate, 2300))
