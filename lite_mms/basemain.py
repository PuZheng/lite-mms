...
nav_bar.register(report_page, name=u"报表列表", default_url="/report/report-list", permissions=[AccountantPermission], group=u'报表',
                 enabler=lambda nav: request.path.startswith('/report/report'))
nav_bar.register(report_page, name=u"数据集合列表", default_url="/report/data-sets", permissions=[AccountantPermission], group=u'报表',
                 enabler=lambda nav: request.path.startswith('/report/data-set'))
